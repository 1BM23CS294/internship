...
const GenerateHiringRecommendationsInputSchema = z.object({
  ...
  overallScore: z.number().min(0).max(100).describe('The calculated overall match score (0-100) between the resume and the job description.'),
});
