...
const GenerateHiringRecommendationsInputSchema = z.object({
  ...
  overallScore: z.number().min(0).max(10).describe('The calculated overall match score (0-10) between the resume and the job description.'),
});
